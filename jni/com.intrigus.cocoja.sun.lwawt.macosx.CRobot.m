#include <com.intrigus.cocoja.sun.lwawt.macosx.CRobot.h>
...
#define sun_lwawt_macosx_CRobot_MOUSE_LOCATION_UNKNOWN -1
#define java_awt_event_InputEvent_SHIFT_MASK  (1 << 0)
#define java_awt_event_InputEvent_CTRL_MASK (1 << 1)
#define java_awt_event_InputEvent_META_MASK (1 << 2)
#define java_awt_event_InputEvent_ALT_MASK (1 << 3)
#define java_awt_event_InputEvent_ALT_GRAPH_MASK  (1 << 5)
#define java_awt_event_InputEvent_BUTTON1_MASK  (1 << 4)
#define java_awt_event_InputEvent_BUTTON2_MASK (1 << 3)
#define java_awt_event_InputEvent_BUTTON3_MASK (1 << 2)
#define java_awt_event_InputEvent_SHIFT_DOWN_MASK  (1 << 6)
#define java_awt_event_InputEvent_CTRL_DOWN_MASK  (1 << 7)
#define java_awt_event_InputEvent_META_DOWN_MASK  (1 << 8)
#define java_awt_event_InputEvent_ALT_DOWN_MASK  (1 << 9)
#define java_awt_event_InputEvent_BUTTON1_DOWN_MASK  (1 << 10)
#define java_awt_event_InputEvent_BUTTON2_DOWN_MASK  (1 << 11)
#define java_awt_event_InputEvent_BUTTON3_DOWN_MASK  (1 << 12)
#define java_awt_event_InputEvent_ALT_GRAPH_DOWN_MASK  (1 << 13)
...
JNIEXPORT void JNICALL Java_com_intrigus_cocoja_sun_lwawt_macosx_CRobot_initIds(JNIEnv* env, jclass clazz) {


//@line:420

	NSLog(@"programm ist im else zweig");
	void (^block)(void);
     block = ^(void){
	NSLog(@"programm ist im vvvelse zweig");
	
	
	
	gNumberOfButtons = 5;//sun_lwawt_macosx_LWCToolkit_BUTTONS;

    jclass inputEventClazz = (*env)->FindClass(env, "com/intrigus/cocoja/java/awt/event/InputEvent");
    ...
    (*env)->DeleteLocalRef(env, obj);
     ...
     if ( [NSThread isMainThread]){
        NSLog(@"programm ist im main zweig");
        block();
        NSLog(@"programm ist im after main zweig");
     } else {
        NSLog(@"programm ist im no main zweig");
        [JNFRunLoop performOnMainThreadWaiting:YES withBlock:block];
        NSLog(@"programm ist im after no main zweig");
     }


}

JNIEXPORT void JNICALL Java_com_intrigus_cocoja_sun_lwawt_macosx_CRobot_mouseWheel(JNIEnv* env, jobject object, jint wheelAmt) {
...
JNIEXPORT void JNICALL Java_com_intrigus_cocoja_sun_lwawt_macosx_CRobot_initRobot(JNIEnv* env, jobject object) {
...
JNIEXPORT void JNICALL Java_com_intrigus_cocoja_sun_lwawt_macosx_CRobot_mouseEvent(JNIEnv* env, jobject object, jint displayID, jint mouseLastX, jint mouseLastY, jint buttonsState, jboolean isButtonsDownState, jboolean isMouseMove) {
...
JNIEXPORT void JNICALL Java_com_intrigus_cocoja_sun_lwawt_macosx_CRobot_keyEvent(JNIEnv* env, jobject object, jint javaKeyCode, jboolean keyPressed) {
