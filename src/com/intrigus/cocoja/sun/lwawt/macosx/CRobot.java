...
package com.intrigus.cocoja.sun.lwawt.macosx;
...
*/
	...
	/** Uses the given GraphicsDevice as the coordinate system for subsequent coordinate calls. */
	...
	public void mouseMove (int x, int y) {
		...
		mouseEvent(fDevice.getCGDisplayID(), mouseLastX, mouseLastY, mouseButtonsState, true, true);
	}

	/** Presses one or more mouse buttons.
	 *
	 * @param buttons the button mask (combination of <code>InputEvent.BUTTON1/2/3_MASK</code>) */
	@Override
	public void mousePress (int buttons) {
		mouseButtonsState |= buttons;

		mouseEvent(fDevice.getCGDisplayID(), mouseLastX, mouseLastY, buttons, true, false);
	}
	...
	public void mouseRelease (int buttons) {
		...
		mouseEvent(fDevice.getCGDisplayID(), mouseLastX, mouseLastY, buttons, false, false);
	}
	...
	*/
	 ...
	 * <p>
	 * Assumes that the peer implementations will throw an exception for other bogus values e.g. -1, 999999
	 *
	...
	*/
	...
	//@off
	private native void mouseEvent (int displayID, int mouseLastX, int mouseLastY, int buttonsState, boolean isButtonsDownState,
		boolean isMouseMove);/*
	    JNF_COCOA_ENTER(env);
	...
	*/
	...
	//@off
	private native void keyEvent (int javaKeyCode, boolean keyPressed);/*
	//
